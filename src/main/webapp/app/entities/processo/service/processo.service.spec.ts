...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../processo.test-samples';
...
const requireRestSample: RestProcesso = {
  ...
  dataVisualizacao: sampleWithRequiredData.dataVisualizacao?.format(DATE_FORMAT),
};
